...
const firebaseConfig = {
  apiKey: "AIzaSyCaY5daIygxycVYcvYOQ-RcV5ZZy9j9mLM",
  authDomain: "smartdcabiao.firebaseapp.com",
  projectId: "smartdcabiao",
  storageBucket: "smartdcabiao.firebasestorage.app",
  messagingSenderId: "166828647370",
  appId: "1:166828647370:web:6063370981176d1fa8e533"
}
...
async function seedData() {
  ...
  console.log('Created season: Cabiao Green Season 2026')
  ...
  console.log('\nDone! Created 1 season and 6 quests.')
  console.log('Now go to /events to see the quests!')
}
