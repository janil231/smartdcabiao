...
export default function OwnerQuestCompactCard({ quest, businessId, businessName, businessImage }) {
  ...
  return (
    <>
      <button
        ...
        className="group relative flex flex-col w-full text-left bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md hover:border-emerald-300 transition-all overflow-hidden h-full"
      >
